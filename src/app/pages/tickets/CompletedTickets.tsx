...
import type {
  ...
  MikrosystemTicketsFinalizadosDatos,
  WispHubListaTicketsBoton,
  WispHubTicketsFinalizadosDatos,
} from '../../types';
...
export default function CompletedTickets() {
  ...
  const datosWispHub: WispHubTicketsFinalizadosDatos = {
    ...
    filtros: {
      ...
      opcionesVista: [
        ...
        { valor: 'finalizados', etiqueta: 'Tickets Finalizados' },
      ],
      botonTexto: 'Filtrar',
    },
    buscadorCliente: {
  ...
  const datosMikrosystem: MikrosystemTicketsFinalizadosDatos = {
    tituloPagina: 'Ticket Cerrados',
    tituloPanel: 'Lista de Ticket Cerrados',
    breadcrumb: {
      inicio: 'Inicio',
      modulo: 'soporte',
    },
