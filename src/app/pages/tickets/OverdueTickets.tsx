...
import type {
  ...
  MikrosystemTicketsEnProcesoDatos,
  WispHubListaTicketsBoton,
  WispHubTicketsEnProcesoDatos,
} from '../../types';
...
export default function InProgressTickets() {
  ...
  const datosWispHub: WispHubTicketsEnProcesoDatos = {
    tituloPagina: 'Tickets en Proceso',
    filtros: {
      desde: startDate,
      hasta: endDate,
      ...
      opcionesVista: [
        ...
        { valor: 'en-proceso', etiqueta: 'Tickets en Proceso' },
  ...
  const datosMikrosystem: MikrosystemTicketsEnProcesoDatos = {
    tituloPagina: 'Ticket en Proceso',
    tituloPanel: 'Lista de Ticket en Proceso',
    breadcrumb: {
      inicio: 'Inicio',
      modulo: 'soporte',
    },
      ...
      <div style={estilosWispHub.pagina}>
        <header style={estilosWispHub.encabezado}>
          <div className="flex items-center gap-3">
            <Clock3 className="h-8 w-8 text-[#45bf63]" strokeWidth={2} />
