          ...
          <div className="flex flex-col gap-4 2xl:flex-row 2xl:items-center 2xl:justify-between">
            <div className="flex flex-wrap items-center gap-3">
              <div className="inline-flex items-stretch overflow-hidden rounded-[4px] border border-[#cdd8e4] bg-white align-middle">
                ...
                <button type="button" className={`${iconButtonClass} shrink-0 rounded-none border-0 border-r border-[#cdd8e4]`} aria-label="Vista lista">
                  <List className="h-5 w-5" />
                </button>
                <button type="button" className={`${iconButtonClass} shrink-0 rounded-none border-0`} aria-label="Guardar configuracion">
